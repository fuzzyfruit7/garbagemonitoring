...
void gmail()
{
  EMailSender::EMailMessage message;
    ...
    message.subject = "SMART_BIN_"+data1;
    message.message = "This_is_Mail_From_ESP8266:"+data1;

    EMailSender::Response resp = emailSend.send("saisathwik405@gmail.com", message);
...
//const char* _getLink4 = "https://api.thingspeak.com/update?api_key=6LYMPTR0BSXNNR5X&field1="; // Thingspeak.com
